...
void EscMenu::createButtons()
{
    ...
    this->_quit_button_gui = this->_gui->addButton(irr::core::rect<irr::s32>(1900 / 3, 1080 / 3 + 160, 1900 / 2.1, 1080 / 2.6 + 160));
    ...
    this->_button_array.push_back(std::make_tuple(2, 0, this->_quit_button_gui, this->_quit_button_pre_tx, this->_quit_button_hover_tx));

...
void Game::createPlayers()
{
    ...
    std::string path;
    path.assign(BASE_PATH).append(std::to_string(this->_players.at(0).second.id)).append("pathTex.png");
    if (this->_players.at(0).first == IA)
    ...
    else if (this->_players.at(0).first != NOTHING)
    ...
    path.assign(BASE_PATH).append(std::to_string(this->_players.at(1).second.id)).append("pathTex.png");
    if (this->_players.at(1).first == IA)
    ...
    else if (this->_players.at(1).first != NOTHING)
        ...
        this->_allPlayers.push_back(nullptr);
    path.assign(BASE_PATH).append(std::to_string(this->_players.at(2).second.id)).append("pathTex.png");
    if (this->_players.at(2).first == IA)
    ...
    else if (this->_players.at(2).first != NOTHING)
        ...
        this->_allPlayers.push_back(nullptr);
    path.assign(BASE_PATH).append(std::to_string(this->_players.at(3).second.id)).append("pathTex.png");
    if (this->_players.at(3).first == IA)
    ...
    else if (this->_players.at(3).first != NOTHING)
...
void Game::run()
{
    createImages();
    int stop = DEFAULT;
    while (this->_device->run() && stop != EXIT && !this->_core->getBackToMainMenu() && !this->_core->getEndGame()) {
...
void Game::setPlayerBonus(IPlayer *player, int id)
{
    ...
    this->_core->getMusic()->loadSound("bonus", 2);
